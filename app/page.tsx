...
import { appendCrop, cropsSelection, selectionCrops, selectionLabel } from '@/lib/crops';
...
export default function Home() {
  ...
  function pickSelection(value: Selection) {
    if (busy) return;
    try {
      setSelection(appendCrop(scope === 'selection' ? selection : null, value));
