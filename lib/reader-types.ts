...
export type Chat = { id: string; paperId: string; question: string; answer: string; selection: Selection; model: string; createdAt: string; status: 'pending' | 'completed' | 'error' | 'cancelled' | 'interrupted'; error?: string };
